...
def fmin_bfgs(f, x0, fprime=None, args=(), gtol=1e-5, norm=Inf,
              ...
              retall=0, callback=None, errorThreshold=1e-3):
    ...
    while old_fval>errorThreshold and (k < maxiter):#(gnorm > gtol) and (k < maxiter):
        print "iteration: " + str(k) + " error : "+str(old_fval) + " gnorm: " + str(gnorm)
        pk = -numpy.dot(Hk,gfk)
       ...
       # print type(gfkp1), type(gfk)
        ...
        Hk = numpy.dot(A1,numpy.dot(Hk,A2)) + rhok * sk[:,numpy.newaxis] \
                 * sk[numpy.newaxis,:]
##        print old_fval,errorThreshold,old_fval>errorThreshold
...
def fmin_cg(f, x0, fprime=None, args=(), gtol=1e-8, norm=Inf, epsilon=_epsilon,
